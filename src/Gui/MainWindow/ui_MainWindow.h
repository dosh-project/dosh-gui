...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/dosh"), QSize(), QIcon::Normal, QIcon::Off);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
...
#endif // QT_NO_TOOLTIP
        m_aboutIntensecoinAction->setText(QApplication::translate("MainWindow", "About DOSH", Q_NULLPTR));
        ...
        m_sendButton->setText(QApplication::translate("MainWindow", "SEND DOSH", Q_NULLPTR));
